    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white shadow-sm">
        ...
        >
          ...
          <span className="text-[#00E676] text-lg leading-none">
            {howOpen ? "−" : "+"}
          </span>
        </button>
        {howOpen && (
          ...
          <form onSubmit={sendCopy}>
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="rounded-xl bg-[#00E676] text-[#0A1628] font-bold text-sm px-6 py-3 hover:bg-[#00c765] transition-colors disabled:opacity-70"
              >
