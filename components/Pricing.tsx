...
const tiers = [
  {
    ...
    price: "$0",
    priceSuffix: "/mo",
    description: "No monthly fee. Add a card once, then only pay $49 when a check's report is completed.",
    popular: false,
    cta: "Get Started",
    ctaHref: "/start-trial?tier=payg",
  ...
  },
  {
    ...
    popular: false,
    cta: "Subscribe",
    ctaHref: "/start-trial?tier=starter",
    ctaClass: "bg-[#0A1628] text-white hover:bg-[#0D1F3C]",
  },
  {
    name: "Professional",
    ...
    popular: true,
    cta: "Subscribe",
    ctaHref: "/start-trial?tier=professional",
