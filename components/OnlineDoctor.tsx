      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 bg-[#00E676] text-[#0A1628] px-6 py-3 rounded-full font-semibold hover:bg-[#00E676] transition-colors"
            >
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 w-80 text-center border border-gray-100">
                ...
                <div className="flex gap-3 justify-center">
                  <button className="flex-1 bg-[#00E676] text-[#0A1628] py-3 rounded-xl font-semibold hover:bg-[#00E676] transition-colors">
                    Book
                  </button>
