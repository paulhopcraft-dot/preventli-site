  ...
  return (
    <section className="relative overflow-hidden bg-[#0A1628] pt-28 pb-16 lg:pt-36 lg:pb-24">
      ...
      <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full opacity-15"
        style={{ background: "radial-gradient(circle, #9CB81E 0%, transparent 70%)" }}
      />
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-10 items-center">
          {/* Left: pitch */}
          <div>
            <div className="inline-flex items-center gap-2 bg-[#9CB81E]/10 border border-[#9CB81E]/30 rounded-full px-4 py-2 mb-7">
          ...
          <div className="relative" aria-hidden="true">
            <div className="relative rounded-2xl border border-white/15 bg-[#0D1F3C] shadow-2xl shadow-black/40 overflow-hidden">
              ...
              <div className="p-5">
                ...
                <div className="flex gap-3 mb-5">
                  <div className="flex-shrink-0 w-9 h-9 rounded-full bg-[#9CB81E] flex items-center justify-center text-[#0A1628] font-bold text-sm">A</div>
                  <div className="rounded-2xl rounded-tl-sm bg-[#9CB81E]/10 border border-[#9CB81E]/20 px-4 py-3">
                    <div className="text-[11px] uppercase tracking-wide text-[#9CB81E] font-semibold mb-1">Alex · your twin</div>
                ...
                <div className="space-y-2 mb-4">
                  {doneOvernight.map((item) => (
                    <div key={item.text} className="flex items-center gap-3 rounded-lg bg-white/[0.04] border border-white/[0.07] px-3.5 py-2.5">
                      <span className="flex-shrink-0 flex h-5 w-5 items-center justify-center rounded-full bg-[#9CB81E]/15">
                        <svg width="12" height="12" fill="none" stroke="#9CB81E" strokeWidth="3" viewBox="0 0 24 24"><polyline points="20 6 9 17 4 12" /></svg>
                      </span>
                ...
                <div className="rounded-lg bg-white/[0.04] border border-white/[0.07] px-3.5 py-3 mb-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[11px] text-[#9CB81E] font-semibold">Week 3 of 6 · on track</span>
                  </div>
                  <svg viewBox="0 0 260 56" className="w-full h-12" preserveAspectRatio="none">
                    ...
                    <polyline points="0,48 52,44 104,34 156,22 208,14 260,6" fill="none" stroke="#9CB81E" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                    {[[0,48],[52,44],[104,34],[156,22],[208,14],[260,6]].map(([x,y],i)=>(
                      <circle key={i} cx={x} cy={y} r={i===2?"4":"3"} fill={i===2?"#9CB81E":"#0D1F3C"} stroke="#9CB81E" strokeWidth="2" />
                    ))}
                  </svg>
            ...
            <div className="animate-float absolute -bottom-5 -left-4 sm:-left-8 flex items-center gap-3 rounded-xl bg-white px-4 py-3 shadow-xl">
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#9CB81E] text-[#0A1628] font-bold text-sm">A</span>
              <div>
        ...
        <div className="mt-20 lg:mt-24 grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-white/10 border-y border-white/10">
          {[
            ...
            <div key={label} className="flex items-baseline justify-center gap-2 py-5">
              <span className="text-2xl font-bold text-[#9CB81E]">{stat}</span>
