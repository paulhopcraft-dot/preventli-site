        ...
        <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 sm:p-8 mb-8 border border-gray-200 shadow-lg">
          <div className="mb-6">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00E676] to-[#00E676] flex items-center justify-center text-white text-xl font-bold">
                {assessmentType === "individual" && "👤"}
                {assessmentType === "psychosocial" && "🧠"}
                {assessmentType === "wellbeing" && "💚"}
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-[#00E676] to-[#00E676] transition-all duration-300 ease-out"
            ...
            {currentQuestions.map((category, catIndex) => (
              <div key={catIndex} className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-2 h-8 bg-gradient-to-b from-[#00E676] to-[#00E676] rounded-full" />
          ...
          <div className="flex gap-4 mt-6">
            <button
              ...
              className="flex-1 bg-[#00E676] text-[#0A1628] px-6 py-3 rounded-lg font-semibold hover:bg-[#00E676] transition-all"
            >
              Get Risk Assessment
            </button>
            <button
